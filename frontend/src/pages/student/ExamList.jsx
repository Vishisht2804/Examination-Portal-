              ...
              <div key={exam.id} className="flex flex-col overflow-hidden rounded-lg border border-slate-200 bg-white shadow-md hover:shadow-xl transition-shadow">
                ...
                <div className="border-t border-slate-200 bg-slate-50 p-4">
                  <button
                    ...
                    className="w-full rounded-lg bg-sky-600 py-3 font-semibold text-white hover:bg-sky-700 transition-colors duration-200 flex items-center justify-center gap-2"
                  >
